...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine(@"*Дан файл С:\DataSprint5\InPutDataFileTask5V9.txt (файл взять из архива с*");
        Console.WriteLine(@"*огласно вашему варианту. Создать папку в ручную С:\DataSprint5\ и скопир*");
